<?php //form action redirects to the actual form. Include the handle form here
    ...
    //Log-in form
     ...
     include '../CSC226Assignment3/handleLoginForm.inc.php';
?>
...
<!DOCTYPE html> <!-- php form -->
  <html>
    ...
    <head>
        <title>Part 2 Assignment 3</title>
    ...
    <body>
        <div class="container">
        <form action="../CSC226Assignment3/part2.php" method="POST"> <!--Using HTTP method POST -->
            <p>
            <div class="title">
            <p> Login Form
            </div>
